import type { BioEntry, Project, NavLink } from './types';
...
export const projects: Project[] = [
  {
    ...
    forkedFrom: { label: 'con2/harakka', url: 'https://github.com/con2/harakka' },
    description:
      'A multi-tenancy full-stack web application, developed as part of an internship team project at Business College Helsinki. Lets users browse, book and manage storage items across tenants.',
    language: 'TypeScript',
    accent: 'var(--pink)',
  },
  {
    ...
    description:
      'My first own side project, back when I was new to coding — built from a tutorial and then customized on top of it.',
    language: 'JavaScript',
    accent: 'var(--cyan)',
  },
  {
    id: 'timelink-client',
    name: 'timeLink-client',
    url: 'https://github.com/stabjana/timeLink-client',
    description: 'Client for timeLink — more details soon.',
    language: 'TypeScript',
    accent: 'var(--green)',
  },
];
